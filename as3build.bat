...
set COMPILER_PATH=D:\dev\royale-emulation-works\apache-royale-%VERSION%-bin-js-swf\royale-asjs\js\bin

set SRCPATH=D:\dev\royale-emulation-works\github\as3corelib\

rem set swflib=D:\dev\royale-emulation-works\apache-royale-%VERSION%-bin-js-swf\royale-asjs\frameworks\projects\MXRoyale\target\MXRoyale-%VERSION%-SNAPSHOT-swf.swc
rem set jslib=D:\dev\royale-emulation-works\apache-royale-%VERSION%-bin-js-swf\royale-asjs\frameworks\projects\MXRoyale\target\MXRoyale-%VERSION%-SNAPSHOT-js.swc

set GITREPO=D:\dev\royale-emulation-works\github\royale-asjs\frameworks\projects
set MX_SWC=%GITREPO%\MXRoyale\target\MXRoyale-%VERSION%-SNAPSHOT-swf.swc
set MX_JS=%GITREPO%\MXRoyale\target\MXRoyale-%VERSION%-SNAPSHOT-js.swc
